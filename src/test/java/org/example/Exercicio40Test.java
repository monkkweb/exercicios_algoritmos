...
public class Exercicio40Test {
    ...
    public void se_quantidade_for_menor_ou_igual_cinco_aplica_desconto_de_dois_porcento(double descontoEsperado,
    ...
    public void quando_quantidade_menor_que_cinco_desconto_de_2_porcento_eh_aplicado(int totalAhPagarEsperado,
                                                                                     int quantidade, double preco,
                                                                                     String operador) {
        var valorParaVenda = calculadora.calcular(preco, quantidade);
